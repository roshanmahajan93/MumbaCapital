...
public class CustomerOneDayAndLoanCompleteReportAdapter extends  BaseAdapter
{
    Context context;
    List<CustomerTwoAndFiftyReport> JobsList;


    public CustomerOneDayAndLoanCompleteReportAdapter(Context context, List<CustomerTwoAndFiftyReport> modelList) {
