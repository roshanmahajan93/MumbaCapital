...
public class DeleteCustomerLastRecordActivity extends Activity {
    ...
    public void delete_last_record_report()
    {
        ...
        Call<ResponseBody> call3 = apiInterface.delete_last_record_report();
        call3.enqueue(new Callback<ResponseBody>() {
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                t.printStackTrace();
                Toast.makeText(DeleteCustomerLastRecordActivity.this, ""+t.getMessage(), Toast.LENGTH_LONG).show();
                if (progress != null && progress.isShowing()) {
                    progress.dismiss();
                }
            }
