...
public class LoginActivity extends Activity {
    ...
    public void getLogin()
    {
        ...
        requestBody = new MultipartBody.Builder()
                ...
                .addFormDataPart("username", et_loginid.getText().toString() + "")
                .addFormDataPart("userpassword", et_password.getText().toString() + "")
                .build();


        Call<ResponseBody> call3 = apiInterface.getLoginData(requestBody);
