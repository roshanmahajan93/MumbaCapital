...
import com.example.mumbacapital.Adapter.ImageAdapter;
import com.example.mumbacapital.R;

public class MainActivity extends Activity {
    static final String[] MOBILE_OS = new String[]{
            "New Customer", "Edit Customer", "Search Customer", "Customer Daily Entry", "2 days Report", "100 Day Complete Report", "1 days Before Report", "Loan Complete Report", "Delete Account Detail", "Daily Entry Report", "Delete Last Report", "Document Detail"};

    private long firstTime = 0;

    private TextView textView3;
    private GridView gridView;
    private ImageButton imgBtn_logout,imgBtn_message;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgBtn_message = (ImageButton) findViewById(R.id.imgBtn_message);
        ...
        imgBtn_message.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getBaseContext(), MassageActivity.class);
                startActivity(i);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View v,
                ...
                if (selectitem.equals("100 Day Complete Report")) {
                    Intent i = new Intent(getBaseContext(), TwoDaysAndFiftyDaysReportActivity.class);
                    i.putExtra("ActivityName", "100daysReport");
                    startActivity(i);
                    overridePendingTransition(R.anim.right_in, R.anim.left_out);
                }

                if (selectitem.equals("1 days Before Report")) {
                    Intent i = new Intent(getBaseContext(), TwoDaysAndFiftyDaysReportActivity.class);
                    i.putExtra("ActivityName", "2daysReport");
                    startActivity(i);
                    overridePendingTransition(R.anim.right_in, R.anim.left_out);
                ...
                if (selectitem.equals("Loan Complete Report")) {
                    Intent i = new Intent(getBaseContext(), TwoDaysAndFiftyDaysReportActivity.class);
                    i.putExtra("ActivityName", "100daysReport");
                    startActivity(i);
                    overridePendingTransition(R.anim.right_in, R.anim.left_out);
                ...
                if (selectitem.equals("Document Detail")) {
                    Intent i = new Intent(getBaseContext(), SearchListActivity.class);
                    i.putExtra("ActivityName", "DocumentDetail");
                    startActivity(i);
                    overridePendingTransition(R.anim.right_in, R.anim.left_out);
