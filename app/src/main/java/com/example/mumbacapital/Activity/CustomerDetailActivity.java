...
public class CustomerDetailActivity extends Activity implements OnClickListener {
    ...
    private TextInputLayout Til_daily_amount,Til_rate_of_interest,Til_interest_amount_for_month,Til_loan_completion_date;
    ...
    EditText et_interest_amount_for_month;
    EditText et_loan_completion_date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Til_daily_amount = (TextInputLayout) findViewById(R.id.Til_daily_amount);
        ...
        et_rate_of_interest = (EditText) findViewById(R.id.et_rate_of_interest);
        et_interest_amount_for_month = (EditText) findViewById(R.id.et_interest_amount_for_month);
        et_loan_completion_date = (EditText) findViewById(R.id.et_loan_completion_date);

        Til_rate_of_interest = (TextInputLayout) findViewById(R.id.Til_rate_of_interest);
        Til_interest_amount_for_month = (TextInputLayout) findViewById(R.id.Til_interest_amount_for_month);
        Til_loan_completion_date = (TextInputLayout) findViewById(R.id.Til_loan_completion_date);
        ...
        Log.e("CustomerDetailActivity", "---->" + UserName);
        ...
        if (ActivityName.equalsIgnoreCase("EditCustomer"))
        {
            ...
            if(RateOfInterest.equalsIgnoreCase("") || RateOfInterest.equalsIgnoreCase("0"))
            {
                ...
                Til_rate_of_interest.setVisibility(View.GONE);
                Til_interest_amount_for_month.setVisibility(View.GONE);
                Til_loan_completion_date.setVisibility(View.GONE);
            }
            else {
                Til_daily_amount.setVisibility(View.GONE);
                et_rate_of_interest.setText(RateOfInterest);
                et_interest_amount_for_month.setText(InterestAmountPerMonth);
                et_loan_completion_date.setText(LoanCompletionDate);
            }
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                if (null != rb) {
                    if (rb.getText().toString().equalsIgnoreCase("Daily")) {
                        radioTemp = 0;
                        Toast.makeText(CustomerDetailActivity.this, rb.getText(), Toast.LENGTH_SHORT).show();
                        Til_daily_amount.setVisibility(View.VISIBLE);
                        et_daily_amount.setText("");
                        Til_rate_of_interest.setVisibility(View.GONE);
                        Til_interest_amount_for_month.setVisibility(View.GONE);
                        Til_loan_completion_date.setVisibility(View.GONE);
                        ...
                        Toast.makeText(CustomerDetailActivity.this, rb.getText(), Toast.LENGTH_SHORT).show();
                        Til_daily_amount.setVisibility(View.GONE);
                        Til_rate_of_interest.setVisibility(View.VISIBLE);
                        Til_interest_amount_for_month.setVisibility(View.VISIBLE);
                        Til_loan_completion_date.setVisibility(View.VISIBLE);

                        et_rate_of_interest.setText("");
                        et_interest_amount_for_month.setText("");
                        et_loan_completion_date.setText("");
                    }
        ...
        et_loan_completion_date.setInputType(InputType.TYPE_NULL);
        et_loan_completion_date.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                hideKeyboard(v);
            }
        });
        et_loan_completion_date.setOnClickListener(this);
        ...
        et_amount.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                if (!tempcs.equalsIgnoreCase("")) {
                    ...
                    if (radioTemp == 0) {
                        if (number <= 1000) {
                            et_daily_amount.setText("10");
                        } else {
                            et_daily_amount.setText("" + ((number / 1000) * 10));
                        }
                    }
        ...
        et_rate_of_interest.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                if (!tempcs.equalsIgnoreCase("")) {
                    ...
                    int rateofinterest = Integer.parseInt(""+tempcs);
                    int amount = Integer.parseInt(""+et_amount.getText().toString());

                    int totalBalancetemp = 0;
                    if(!totalBalance.equalsIgnoreCase("") && !totalBalance.equalsIgnoreCase("null") && !totalBalance.equalsIgnoreCase("0"))
                    {
                        totalBalancetemp = Integer.parseInt(""+totalBalance);
                        et_interest_amount_for_month.setText("" + (totalBalancetemp * rateofinterest * 1)/100);
                    }
                    else
                    {
                        et_interest_amount_for_month.setText("" + (amount * rateofinterest * 1)/100);
                    }
        ...
        btn_submit.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!isNetworkConnected()) {
                    ...
                    insert_and_update_customer_detail();
...
//        Log.e("data","---->"+data.getExtras().get("data"));
    ...
    public void onClick(View v) {
        ...
        if (v == et_loan_completion_date) {
            v.startAnimation(alphaAnimation);
            et_loan_completion_date.setError(null);
            ...
            final DatePickerDialog dpd = new DatePickerDialog(this,
                    new DatePickerDialog.OnDateSetListener() {
                        ...
                        public void onDateSet(DatePicker view, int year,
                            ...
                            et_loan_completion_date.setText(d + "-" + m + "-" + year);

                            String currdate = et_loan_completion_date.getText().toString().trim();
    ...
    public void insert_and_update_customer_detail()
    {
        ...
        requestBody = new MultipartBody.Builder()
                ...
                .addFormDataPart("CardNo", txt_card_no.getText().toString()+"")
                .addFormDataPart("CustName", et_cust_name.getText().toString() + "")
                .addFormDataPart("ContactNo", et_contact_no.getText().toString() + "")
                .addFormDataPart("HomeAddress", et_home_address.getText().toString() + "")
                .addFormDataPart("BusiAddress", et_business_addrress.getText().toString() + "")
                .addFormDataPart("Amount", et_amount.getText().toString() + "")
                .addFormDataPart("DailyAmt", et_daily_amount.getText().toString() + "")
                .addFormDataPart("AmtDate", et_date.getText().toString() + "")
                .addFormDataPart("GuarantorOrIntroducerName", et_granter_name.getText().toString() + "")
                .addFormDataPart("GContactNo", et_granter_contact.getText().toString() + "")
                .addFormDataPart("PhotoPath", PhotoPath+"")
                .addFormDataPart("UserId", UserId + "")
                .addFormDataPart("DecodeString", decodeString+"")
                .addFormDataPart("RateOfInterest", et_rate_of_interest.getText().toString()+"")
                .addFormDataPart("InterestAmountPerMonth", et_interest_amount_for_month.getText().toString() + "")
                .addFormDataPart("LoanCompletionDate", et_loan_completion_date.getText().toString()+"")
                .build();

        Call<ResponseBody> call3 = apiInterface.insert_and_update_customer_detail(requestBody);
        call3.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, retrofit2.Response<ResponseBody> response) {
                try {
                    ...
                    if (rslt.equalsIgnoreCase("Fail")) {
                        ...
                        Log.e("Inside_ELSE", "LoginActivity--->Success"+rslt);
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                t.printStackTrace();
                Toast.makeText(CustomerDetailActivity.this, ""+t.getMessage(), Toast.LENGTH_LONG).show();
                if (progress != null && progress.isShowing()) {
                    progress.dismiss();
                }
            }
    ...
    public void getCardNo()
    {
        ...
        Call<ResponseBody> call3 = apiInterface.getCardNo();
        call3.enqueue(new Callback<ResponseBody>() {
        ...
        protected String doInBackground(String... params) {
            ...
            Thread thread = new Thread(new Runnable() {
                public void run() {
                    ...
                    /*$CardNos = $_POST['CardNo'];
                    $CustName = $_POST['CustName'];
                    $ContactNo = $_POST['ContactNo'];
                    $HomeAddress = $_POST['HomeAddress'];
                    $BusiAddress = $_POST['BusiAddress'];
                    $Amount = $_POST['Amount'];
                    $DailyAmt = $_POST['DailyAmt'];
                    $AmtDate = $_POST['AmtDate'];
                    $GuarantorOrIntroducerName = $_POST['GuarantorOrIntroducerName'];
                    ...
                    nameValuePairs.add(new BasicNameValuePair("RateOfInterest", et_rate_of_interest.getText().toString() + ""));
                    nameValuePairs.add(new BasicNameValuePair("InterestAmountPerMonth", et_interest_amount_for_month.getText().toString() + ""));
                    nameValuePairs.add(new BasicNameValuePair("LoanCompletionDate", et_loan_completion_date.getText().toString() + ""));
                    ...
                    try {
                        ...
                        HttpPost httppost = new HttpPost(Config.YOUR_SERVER_URL + "insert_and_update_customer_detail_test.php");
